...
public class RedisUtil{
    ...
    private static String redisConfigFile = "/daddyok/weapp/config/redis.properties";  
    private RedisUtil() {
    }
    ...
    private void initJedisPool() {
    	try {  
            ...
            //加载连接池配置文件  
    		properties.load(RedisUtil.class.getClassLoader().getResourceAsStream(redisConfigFile));  
            // 创建jedis池配置实例  
    ...
    private Jedis getJedis() {
        if (jedisPool == null) {
            ...
            initJedisPool();
            lock.unlock();
            System.out.println("JedisPool init success！");
        }
